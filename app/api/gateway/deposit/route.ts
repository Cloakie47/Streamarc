...
export async function POST(req: NextRequest) {
  try {
    ...
    // Use requested amount or full balance (leave small buffer for gas)
    ...
    console.log("Depositing to Gateway:", { walletId: user.circle_wallet_id, depositAmount, amountIn6Dec })
